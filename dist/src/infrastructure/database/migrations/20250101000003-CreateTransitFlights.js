...
exports.CreateTransitFlights20250101000003 = void 0;
class CreateTransitFlights20250101000003 {
    up(queryRunner) {
    ...
    `);
            ...
            yield queryRunner.query(`
      ALTER TABLE transit_flights
      ADD CONSTRAINT FK_transit_flights_flight_id
      FOREIGN KEY (flight_id) REFERENCES flights(id)
      ON DELETE CASCADE;
    `);
            yield queryRunner.query(`
      ALTER TABLE transit_flights
      ADD CONSTRAINT FK_transit_flights_airline_id
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`
      ALTER TABLE transit_flights
      DROP FOREIGN KEY IF EXISTS FK_transit_flights_flight_id;
    `);
            yield queryRunner.query(`
      ALTER TABLE transit_flights
      DROP FOREIGN KEY IF EXISTS FK_transit_flights_airline_id;
    `);
            // Then drop the table
            yield queryRunner.dropTable("transit_flights");
        });
    }
}
exports.CreateTransitFlights20250101000003 = CreateTransitFlights20250101000003;
