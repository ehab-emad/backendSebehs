...
const TripSchedule_model_1 = require("../models/TripSchedule.model");
const TripSchedule_1 = require("../../../core/entities/TripSchedule");
let TripScheduleRepository = class TripScheduleRepository {
    get repo() {
        if (!database_config_1.AppDataSource.isInitialized) {
            throw new Error("Data source is not initialized");
        }
        return database_config_1.AppDataSource.getRepository(TripSchedule_model_1.TripScheduleEntity);
    }
    listForTrip(tripId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return ents.map((e) => new TripSchedule_1.TripSchedule(e.id, e.trip_id, e.day, e.title, e.description));
        });
    }
    add(tripId, day, title, description) {
        return __awaiter(this, void 0, void 0, function* () {
